...
const { dbAtlasUser, dbAtlasPassword, dbAtlasName } = require('../app/config/database');
...
const uri = `mongodb+srv://${dbAtlasUser}:${dbAtlasPassword}@peseninv0.tcc5y.mongodb.net/${dbAtlasName}?retryWrites=true&w=majority`;
const options = {
